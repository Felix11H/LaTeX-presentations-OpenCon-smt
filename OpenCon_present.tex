...
\begin{frame}{\includegraphics[width=2.0cm]{sumatra_logo_up.png}
   ...
   \begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=1.5cm,
     ...
     \onslide<5->
     \node (smt) at (0,-2.25) {\includegraphics[width=2.0cm]{sumatra_logo.png}};

     \path[every node/.style={font=\sffamily\small, circle,
       draw}, very thick, color=gray]
       (in.west) edge 	[out=180,in=0] (smt.east);
 
     \path[every node/.style={font=\sffamily\small, circle,
       draw}, very thick, color=gray]
       (smt.east) edge [out=0,in=180] (out.west);

     \path[every node/.style={font=\sffamily\small, circle,
       draw}, very thick, color=gray, <->]
       (smt.west) edge (sc.east);
